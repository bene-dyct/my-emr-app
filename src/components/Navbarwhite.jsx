...
const Navbarwhite = () => {
  ...
  return (
    ...
    initial={{ y: -100 }}
      ...
      className='w-full h-[70px] fixed top-0 left-0 text-[#010080] py-2 z-9999 bg-white'
    >
      <div
...
<li className={`block ${isOpen ? "" : "max-lg:hidden"} pt-2 justify-between 
                          text-black active:text-indigo-900 hover:text-indigo-900 max-lg:text-black max-lg:hover:text-blue-700`} ><NavLink to="/login" className={({ isActive }) => `text-black hover:text-indigo-900 ${isActive ? 'text-indigo-900' : ''}`}>Login</NavLink></li>
                    <li className={`block ${isOpen ? "" : "max-lg:hidden"} pt-2 justify-between 
                   ...
                   <li className={`block ${isOpen ? "" : "max-lg:hidden"} pt-2 justify-between 
                         text-black active:text-indigo-900 hover:text-indigo-900 max-lg:text-black max-lg:hover:text-blue-700`} ><NavLink to="/profile" className={({ isActive }) => `text-black hover:text-indigo-900 ${isActive ? 'text-indigo-900' : ''}`}>Profile</NavLink></li>
